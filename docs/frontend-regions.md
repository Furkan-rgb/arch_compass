...
| **Rounds surface** | Every clarification round the *case* has been through, with what was said to each question and the help thread that was open beside it. The case's history rather than this review's: a round belongs to the question it settled, and the revision it opened is named on its heading. | [clarifications-surface.tsx](../frontend/src/features/review/clarifications-surface.tsx) |
