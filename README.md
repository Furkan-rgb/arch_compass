...
**OpenRouter is the hosted boundary** — one credential, and four named models, each checked
against the live catalogue for structured output and tool calling before it is offered. **Ollama is the
