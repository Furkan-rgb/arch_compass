"""Validated analyzer and atlas-query boundary records."""
...
from archcompass.records import BoundaryDTO, new_id, utc_now
...
class FindingPattern(StrEnum):
    ...
    Both directions of repeated knowledge are present, and the distinction between them
